...
const resources = ref([
  {
    ...
    description:
      "Dive deep into advanced React patterns and improve your component architecture.",
  ...
  },
  {
    ...
    description:
      "Learn the basics of Vue.js and start building reactive web applications.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.5,
    views: 1200,
  ...
  },
  {
    ...
    description:
      "Learn how to build efficient and flexible APIs using GraphQL.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.6,
    views: 1600,
  ...
  },
  {
    ...
    description:
      "Understand containerization and streamline your development workflow with Docker.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.3,
    views: 1900,
  ...
  },
  {
    ...
    description:
      "Enhance your JavaScript projects with the power of TypeScript.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.7,
    views: 2100,
  ...
  },
  {
    ...
    description:
      "Explore the world of serverless computing and build scalable applications.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.5,
    views: 1700,
  ...
  },
  {
    ...
    description:
      "Learn how to implement continuous integration and deployment using GitHub Actions.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.8,
    views: 2400,
  ...
  },
  {
    ...
    description:
      "Master the art of building scalable and maintainable Angular applications.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.6,
    views: 1850,
  ...
  },
  {
    ...
    description:
      "Learn how to integrate MongoDB with Node.js for powerful backend solutions.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.4,
    views: 2050,
  ...
  },
  {
    ...
    description:
      "Dive into serverless computing with AWS Lambda and build scalable applications.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.7,
    views: 2300,
  ...
  },
  {
    ...
    description:
      "Build scalable and maintainable microservices using Spring Boot.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.6,
    views: 2100,
  ...
  },
  {
    ...
    description:
      "Master container orchestration with Kubernetes for efficient DevOps practices.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.8,
    views: 2500,
  ...
  },
  {
    ...
    description:
      "Learn how to build fast and SEO-friendly React applications with Next.js.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.7,
    views: 2200,
  ...
  },
  {
    ...
    description:
      "Implement efficient data fetching in your frontend applications using GraphQL and Apollo Client.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.5,
    views: 1900,
  ...
  },
  {
    ...
    description:
      "Set up robust CI/CD pipelines using GitLab for seamless software delivery.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.6,
    views: 2000,
  ...
  },
  {
    ...
    description:
      "Explore serverless computing with Azure Functions and build scalable cloud solutions.",
    image: "https://cdn.vuetifyjs.com/images/cards/forest-art.jpg",
    rating: 4.4,
    views: 1800,
...
const initializeSearchSuggestions = () => {
  ...
  Object.keys(subcategoryOptions).forEach((subcategory) =>
...
const filteredResources = computed(() => {
  return resources.value
    .filter((resource) => {
      const groupMatch =
        filters.value.group.includes("All") ||
        filters.value.group.length === 0 ||
        filters.value.group.some((g) => resource.tags.includes(g));
      const categoryMatch =
        filters.value.category.includes("All") ||
        filters.value.category.length === 0 ||
        filters.value.category.some((c) => resource.tags.includes(c));
      const subcategoryMatch =
        filters.value.subcategory.includes("All") ||
        filters.value.subcategory.length === 0 ||
        filters.value.subcategory.some((s) => resource.tags.includes(s));
